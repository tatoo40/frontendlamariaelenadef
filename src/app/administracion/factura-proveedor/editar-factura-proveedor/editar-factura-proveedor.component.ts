...
export class EditarFacturasProvComponent implements OnInit {
  ...
  constructor(
    ...
    this.importe_iva_basico_mo = this.invoice.importe_iva_basico_mo;
    this.importe_iva_minimo_mo = this.invoice.importe_iva_minimo_mo;
    this.importe_iva_excento_mo = this.invoice.importe_iva_excento_mo;
  ...
  btnRemoveClick(i: number): void {
    ...
    this.importe_iva_basico_mo = this.importe_mo / 22;
    this.importe_total_mo = this.importe_mo + this.importe_iva_basico_mo;
