...
import { Datos } from './compras-ganado';
import { ComprasGanadoService } from './compras-ganado.service'; 
...
const appDatoSelector='app-compras-ganado';
...
@Component({
  ...
  templateUrl: './compras-ganado.component.html',
  styleUrls: ['./compras-ganado.component.css'],
})
export class ComprasGanadoComponent implements OnInit {
 ...
 proveedores = this.titulares.filter((proveedor) => proveedor.id_categoria_prov === 1);




  nombreSeccion = 'Compras de ganado';
  ...
  constructor(
    ///////////////////////////////////////////CAMBIAR ACA////////////////////////
    private Datoservice: ComprasGanadoService,
    ...
    if (!this.permisos.evaluoPermisoAccionUsuario(4, this.seccion)) {
      ...
      return;
        ...
        this.Datoservice.getDatos(this.empresas[0].id).subscribe((dato) => {
        this.DatoList = dato;
