...
import { Datos } from './dicoses';
import { DicosesService } from './dicoses.service'
...
@Component({
  ...
  templateUrl: './dicoses.component.html',
  styleUrls: ['./dicoses.component.css'],
})
export class DicosesComponent implements OnInit {
  ...
  nombreSeccion = 'Dicoses';
  nombreSeccionTabla = 'dicoses';
  ...
  constructor(
    ///////////////////////////////////////////CAMBIAR ACA////////////////////////
    private Datoservice:DicosesService,
...
/////////////////CAMBIAR ACA/////////////////////////////
      ...
      if (this.editDato != null) {
        ...
        this.DatoDetail.valor= this.editDato.get('valor')?.value;
