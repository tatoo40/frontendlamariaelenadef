...
const appDatoSelector='app-pasturas';
...
@Component({
  ...
  templateUrl: './pasturas.component.html',
  styleUrls: ['./pasturas.component.css'],
})
export class PasturasComponent implements OnInit {
  ...
  constructor(
    ///////////////////////////////////////////CAMBIAR ACA////////////////////////
    private Datoservice: PasturasService,
  ...
  ngOnInit() {
    ...
    this.editDato = this.fb.group({
      ...
      vida_util_dias: ['', Validators.required],
  ...
  openModal(editDatoModal: any, dato: Datos | null) {
    ...
    if (dato != null) {
      ...
      this.editDato?.patchValue({
        nombre: dato.nombre,
        vida_util_dias: dato.vida_util_dias
...
/////////////////CAMBIAR ACA/////////////////////////////
      ...
      if (this.editDato != null) {
        ...
        this.DatoDetail.vida_util_dias= parseFloat(this.editDato.get('vida_util_dias')?.value);
