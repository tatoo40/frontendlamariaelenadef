...
const appDatoSelector='app-empresa';
...
export class EmpresaComponent implements OnInit {
  ...
  constructor(
    ///////////////////////////////////////////CAMBIAR ACA////////////////////////
    private Datoservice: EmpresaService,
  ...
  openModal(editDatoModal: any, dato: Datos | null) {
    ...
    if (dato != null) {
      ...
      this.editDato?.patchValue({
        ...
        email_contacto:dato.email_contacto,
...
/////////////////CAMBIAR ACA/////////////////////////////
      ...
      if (this.editDato != null) {
        ...
        this.DatoDetail.email_contacto=this.editDato.get('email_contacto')?.value;
