...
const seccion= 'cpt_relaciono_snig';
...
export class RelacionSnigService {

  empresa = JSON.parse(localStorage.getItem('empresas'));

  private sccionGetUrl = 'relacionosnig/'+parseInt(this.empresa.id)+'?ord=desc';
  private seccionUrl = 'relacionosnig/'+parseInt(this.empresa.id);
