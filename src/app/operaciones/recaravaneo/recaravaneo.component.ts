...
import { RecaravaneoService } from './recaravaneo.service';
import { NgSelectConfig, NgSelectModule } from '@ng-select/ng-select';
import { StockService } from 'src/app/services/stock.service';
import { ComponentsModule } from 'src/app/component/component.module';

const appDatoSelector='app-recaravaneo';
...
@Component({
  ...
  templateUrl: './recaravaneo.component.html',
  styleUrls: ['./recaravaneo.component.css'],
})
export class RecaravaneoComponent implements OnInit {
  ...
  constructor(
    ///////////////////////////////////////////CAMBIAR ACA////////////////////////
    private Datoservice: RecaravaneoService,
