...
export class ModificoGanadoService {

  empresa = JSON.parse(localStorage.getItem('empresas'));

  private sccionGetUrl = 'cambiocategoria/'+parseInt(this.empresa.id)+'?ord=desc';
  private seccionUrl = 'cambiocategoria/'+parseInt(this.empresa.id);
